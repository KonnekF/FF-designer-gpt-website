...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        /*********************************/
        // ... (The theme switcher code remains the same, so it's omitted here for brevity, but it should be in your actual file) ...
        ...
        /*********************************/
        // ... (The language switcher code remains the same, so it's omitted here for brevity, but it should be in your actual file) ...
        const translations = {
            en: {
                // Nav & Footer
                ...
                login_subtitle: 'Login or create an account to get started.',
            ...
            fr: {
                ...
                login_subtitle: 'Connectez-vous ou créez un compte pour commencer.',
                login_email_label: 'E-mail',
                login_password_label: 'Mot de passe',
                login_remember_me: 'Se souvenir de moi',
                login_forgot_password: 'Mot de passe oublié ?',
                login_button: 'Connexion / S\'inscrire',
                // Dashboard
        ...
        // This function updates the button visibility based on login status
        ...
        // Initialize the widget and check the user status when the page loads
